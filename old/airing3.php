...
echo "<thead><tr><th></th><th>Title</th><th>Premiere</th><th>Timeslot</th><th>Studio</th><th>Episodes</th><th>Source</th><th>Genre</th></tr></thead>";
while ($row = $result->fetch_assoc()) {
	echo "<tbody><tr>";
	echo "<td><a href=\"viewshow.php?show_id=".$row["show_id"]."\"><img src='http://localhost/soto/".$row['show_visual']."' height='200'></a></td>";
	echo '<td class="title">';
