...
echo "<h3>View Studio</h3>";
echo '<p class="lead">Studio Information</p>';

if (isset($_GET['studio_id'])) {
	$id = sanitizeMySQL($conn, $_GET['studio_id']);
	$query = "SELECT *,
								...
								echo '<div class="col-sm-7">';
									...
									if ($row["season_id"] == "UNKNOWN") {
										echo "TBA";}
											...
											echo "<a href=\"viewseason.php?season_id=".$row["season_id"]."\">".$row["season_name"]." ".$row["season_year"]."</a>";}
	...
	echo "<h4>No Studio ID passed.</h4>";
}
